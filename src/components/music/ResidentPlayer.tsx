        ...
        <div className="p-2">
          <div className="flex flex-col items-center justify-between gap-3">
            <div className="lg:hidden flex items-center justify-center gap-4 w-full">
              <img src={resident.djImageUrl} alt={resident.name} className="w-12 h-12 rounded-full object-cover" />
            ...
            <div className="w-full max-w-md px-4">
              <input type="range" min="0" max="100" value={progress} onChange={handleProgressChange} className="w-full h-1.5 bg-gray-700/50 rounded-lg appearance-none cursor-pointer range-sm" style={progressBarBackground} />
