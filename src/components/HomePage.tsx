...
const HomePage: React.FC = () => {
  return (
    <div className="h-[calc(100vh-8rem)] flex flex-col lg:flex-row gap-4 mx-auto px-4 lg:px-8">
      ...
      <div className="hidden lg:block lg:w-[25%] lg:h-full">
      ...
      <div className="w-full h-full lg:w-[45%] lg:h-full">
        <HeroSection />
      </div>
      
      {/* Radio Player - Mobile: fixed bottom with 90px from navigation, Desktop: right side */}
      <div className="fixed bottom-[110px] left-4 right-4 h-[160px] lg:relative lg:bottom-auto lg:left-auto lg:right-auto lg:w-[30%] lg:h-full z-10">
        <NewRadioPlayer />
      </div>
    </div>
  );
